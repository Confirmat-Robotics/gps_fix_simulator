...
#include <tf2_ros/static_transform_broadcaster.h> // Ensure this include is present
...
namespace gps_fix_simulator
{
  ...
  inline gz::math::Matrix3d ComputeENUtoECEF(double lat_rad, double lon_rad)
  {
...
public:
                 ...
                 gz::sim::EntityComponentManager &ecm) override
  {
    ...
    if ((now - last_tf_broadcast_time).seconds() >= (1.0 / tf_broadcast_rate))
    {
      ...
      //geometry_msgs::msg::Transform H_msg = ENUasTransform(spherical);
